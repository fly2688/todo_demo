...
class AddEditScreen extends StatefulWidget {
  ...
  const AddEditScreen({Key key, this.todo, this.addTodo, this.updateTodo}) : super(key: key);
...
class _AddEditScreenState extends State<AddEditScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isEditing ? ArchSampleLocalizations.of(context).editTodo : ArchSampleLocalizations.of(context).addTodo),
      ),
      body: Padding(
